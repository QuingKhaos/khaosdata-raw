return {
  ...
  opacity_over_water = 0.2,
  order = "XxX[decorative]-a[grass]-b[carpet]",
  pictures = {
    {
      filename = "__space-age__/graphics/decorative/orange-root/orange-root-01.png",
      height = 1257,
      priority = "extra-high",
      scale = 0.5,
      tint = {
    ...
    {
      filename = "__space-age__/graphics/decorative/orange-root/orange-root-02.png",
      height = 1257,
      priority = "extra-high",
      scale = 0.5,
      tint = {
    ...
    {
      filename = "__space-age__/graphics/decorative/orange-root/orange-root-03.png",
      height = 1257,
      priority = "extra-high",
      scale = 0.5,
      tint = {
    ...
    {
      filename = "__space-age__/graphics/decorative/orange-root/orange-root-04.png",
      height = 1257,
      priority = "extra-high",
      scale = 0.5,
      tint = {
    ...
    {
      filename = "__space-age__/graphics/decorative/orange-root/orange-root-05.png",
      height = 1257,
      priority = "extra-high",
      scale = 0.5,
      tint = {
