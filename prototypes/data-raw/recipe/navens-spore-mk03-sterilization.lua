return {
  ...
  localised_description = {
    "?",
    {
      "",
      {
        "recipe-description.navens-spore-mk03-sterilization"
      },
      "\n",
      {
        "turd.font",
  ...
  localised_name = {
    "?",
    {
      "recipe-name.navens-spore-mk03-sterilization"
    },
    {
      "item-name.navens-spore-mk03"
    }
  },
  main_product = "navens-spore-mk03",
  maximum_productivity = 1000000,
  name = "navens-spore-mk03-sterilization",
  order = "zb",
  results = {
    {
      amount = 10,
