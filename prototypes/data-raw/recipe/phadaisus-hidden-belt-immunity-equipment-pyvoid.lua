return {
  ...
  localised_name = {
    "recipe-name.py-void",
    {
      "?",
      {
        "item-name.phadaisus-hidden-belt-immunity-equipment"
      },
      {
        "entity-name.phadaisus-hidden-belt-immunity-equipment"
      },
      ""
    }
  },
  maximum_productivity = 1000000,
  name = "phadaisus-hidden-belt-immunity-equipment-pyvoid",
  results = {
    {
      amount_max = 1,
      amount_min = 1,
