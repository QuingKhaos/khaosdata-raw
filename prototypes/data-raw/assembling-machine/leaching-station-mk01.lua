return {
  ...
  graphics_set = {
    animation = {
      layers = {
        {
          filename = "__pyraworesgraphics__/graphics/entity/leaching-station/off-mk01.png",
          frame_count = 1,
          height = 233,
          shift = {
            0,
    ...
    working_visualisations = {
      {
        animation = {
          filename = "__pyraworesgraphics__/graphics/entity/leaching-station/on-mk01.png",
          frame_count = 1,
          height = 233,
          width = 224
        },
  ...
  module_slots = 1,
  name = "leaching-station-mk01",
  next_upgrade = "leaching-station-mk02",
  open_sound = {
  ...
  working_sound = {
    apparent_volume = 2.5,
    idle_sound = {
      filename = "__pyraworesgraphics__/sounds/leaching-station.ogg",
      volume = 0.3
    },
    sound = {
      filename = "__pyraworesgraphics__/sounds/leaching-station.ogg",
