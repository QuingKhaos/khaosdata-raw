return {
  ...
  crafting_speed = 0.37101449275362319,
  ...
  module_slots = 8,
  name = "phadai-enclosure-mk02",
  next_upgrade = "phadai-enclosure-mk03",
  open_sound = {
  ...
  working_sound = {
    apparent_volume = 1.2,
    idle_sound = {
      filename = "__pyalienlifegraphics__/sounds/phadai-out.ogg",
      volume = 0.9
    },
    sound = {
      filename = "__pyalienlifegraphics__/sounds/phadai-enclosure.ogg",
      volume = 0.55
    }
  }
}
