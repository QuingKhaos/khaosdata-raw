return {
  ...
  crafting_speed = 0.062962962962962958,
  ...
  icon_draw_specification = {
    scale = 3.3300000000000001,
    scale_for_many = 3.3300000000000001
  },
  icon_size = 64,
  icons_positioning = {
    {
      inventory_index = 4,
      max_icons_per_row = 13,
      scale = 0.69833729609374977,
      shift = {
        0,
        1.9273158971875009
      }
  ...
  module_slots = 50,
  name = "kmauts-enclosure-mk01",
  next_upgrade = "kmauts-enclosure-mk02",
  open_sound = {
  ...
  working_sound = {
    apparent_volume = 2.5,
    idle_sound = {
      filename = "__pyfusionenergygraphics__/sounds/kmauts-enclosure.ogg",
      volume = 0.3
    },
    sound = {
      filename = "__pyfusionenergygraphics__/sounds/kmauts-enclosure.ogg",
