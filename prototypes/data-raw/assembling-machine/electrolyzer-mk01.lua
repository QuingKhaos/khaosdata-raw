return {
  ...
  graphics_set = {
    animation = {
      layers = {
        {
          filename = "__pyraworesgraphics__/graphics/entity/electrolyzer/off-mk01.png",
          frame_count = 1,
          height = 192,
          shift = {
            0,
    ...
    working_visualisations = {
      {
        animation = {
          animation_speed = 1.5,
          filename = "__pyraworesgraphics__/graphics/entity/electrolyzer/on-mk01.png",
          frame_count = 60,
          height = 160,
          line_length = 10,
          priority = "high",
  ...
  module_slots = 1,
  name = "electrolyzer-mk01",
  next_upgrade = "electrolyzer-mk02",
  open_sound = {
  ...
  working_sound = {
    apparent_volume = 2.5,
    idle_sound = {
      filename = "__pyraworesgraphics__/sounds/electrolyzer.ogg",
      volume = 0.3
    },
    sound = {
      filename = "__pyraworesgraphics__/sounds/electrolyzer.ogg",
