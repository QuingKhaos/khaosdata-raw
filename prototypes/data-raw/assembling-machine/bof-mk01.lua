return {
  ...
  graphics_set = {
    animation = {
      layers = {
        {
          filename = "__pyraworesgraphics__/graphics/entity/bof/off-mk01.png",
          frame_count = 1,
          height = 288,
          shift = {
            0.53125,
    ...
    working_visualisations = {
      {
        animation = {
          animation_speed = 1,
          filename = "__pyraworesgraphics__/graphics/entity/bof/on-mk01.png",
          frame_count = 24,
          height = 160,
          line_length = 6,
          priority = "high",
  ...
  working_sound = {
    idle_sound = {
      filename = "__pyraworesgraphics__/sounds/bof.ogg",
      volume = 0.02
    },
    sound = {
      filename = "__pyraworesgraphics__/sounds/bof.ogg",
