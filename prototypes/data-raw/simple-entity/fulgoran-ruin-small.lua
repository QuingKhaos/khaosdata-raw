return {
  autoplace = {
    ...
    probability_expression = "0.0005 * (0.1 * fulgora_natural_mask + fulgora_mesa)+ (0.005 + 0.005 * (fulgora_decorative_machine_density - 0.1))* (fulgora_artificial_mask + 0.2 * fulgora_mesa * max(0, fulgora_scrap_medium))"
  },
  collision_box = {
    {
      -0.77000000000000002,
  ...
  icon = "__space-age__/graphics/icons/fulgoran-ruin-small.png",
  ...
  minable = {
    ...
    mining_time = 0.52229513027721062,
    results = {
      {
        amount_max = 9,
        amount_min = 3,
  ...
  pictures = {
    ...
    {
      filename = "__space-age__/graphics/decorative/fulgoran-ruin/fulgoran-ruin-small-tall.png",
      height = 256,
      line_length = 7,
      scale = 0.5,
      shift = {
