return {
  ...
  lower_pictures = {
    filenames = {
      "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-lower-1.png",
      "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-lower-2.png",
      "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-lower-3.png"
    },
    height = 282,
    line_length = 1,
    lines_per_file = 1,
  ...
  pictures = {
    layers = {
      {
        filenames = {
          "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-upper-1.png",
          "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-upper-2.png",
          "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-upper-3.png"
        },
        height = 284,
        line_length = 1,
        lines_per_file = 1,
      ...
      },
      {
        draw_as_shadow = true,
        filenames = {
          "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-shadow-1.png",
          "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-shadow-2.png",
          "__space-age__/graphics/decorative/vulcanus-chimney/sulfuric-chimney-shadow-3.png"
        },
        height = 186,
        line_length = 1,
        lines_per_file = 1,
  ...
  working_sound = {
    ...
    sound = {
      ...
      variations = {
        {
          filename = "__space-age__/sound/world/decoratives/chimney-vent-1.ogg",
          volume = 0.3
        }
      }
    }
