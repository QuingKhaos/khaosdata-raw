return {
  ankle_height = 0,
  base_position_selection_distance = 5.4000000000000004,
  collision_box = {
    {
      -0.05,
      -0.05
  ...
  graphics_set = {
    ...
    lower_part = {
      ...
      middle_offset_from_bottom = 0.0072000000000000011,
      middle_offset_from_top = 0.0072000000000000011,
      top_end_length = 0
    },
    lower_part_shadow = {
      bottom_end_length = 0,
    ...
    lower_part_water_reflection = {
      ...
      middle = {
        ...
        height = 384,
        line_length = 1,
        scale = 0.18000000000000004,
        shift = {
          0.011250000000000002,
          0
        },
        surface = "gleba",
        usage = "enemy",
  ...
  max_health = 100,
  minimal_step_size = 0.9,
  movement_acceleration = 0.1125,
  movement_based_position_selection_distance = 3.6000000000000001,
  name = "small-strafer-pentapod-leg",
  resistances = {
    {
      decrease = 2,
      percent = 10,
  ...
  target_position_randomisation_distance = 0.225,
  type = "spider-leg",
