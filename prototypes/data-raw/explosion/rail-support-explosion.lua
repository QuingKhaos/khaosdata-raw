return {
  ...
  sound = {
    ...
    variations = {
      {
        filename = "__base__/sound/explosions/large-concrete-explosion-1.ogg",
        max_volume = 1,
        min_volume = 0.7
      },
      {
        filename = "__base__/sound/explosions/large-concrete-explosion-2.ogg",
        max_volume = 1,
        min_volume = 0.7
      },
      {
        filename = "__base__/sound/explosions/large-concrete-explosion-3.ogg",
        max_volume = 1,
        min_volume = 0.7
      }
    }
