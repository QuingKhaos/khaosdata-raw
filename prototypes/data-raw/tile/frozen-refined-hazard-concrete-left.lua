return {
  ...
  name = "frozen-refined-hazard-concrete-left",
  needs_correction = false,
  next_direction = "refined-hazard-concrete-right",
  order = "z[frozen-concrete]-frozen-refined-hazard-concrete-left",
  placeable_by = {
    count = 1,
  ...
  thawed_variant = "refined-hazard-concrete-left",
  ...
  variants = {
    material_background = {
      count = 8,
      picture = "__space-age__/graphics/terrain/aquilo/frozen-refined-hazard-concrete-left.png",
      scale = 0.5
    },
    transition = {
      mask_layout = {
