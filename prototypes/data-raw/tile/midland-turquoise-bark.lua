return {
  ...
  autoplace = {
    probability_expression = "gleba_midland * gleba_select(gleba_aux, 0, 0.35, 0.2, 0, 1) + 0.2 * gleba_temperature_normalised"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  transitions = {
    ...
    },
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/midland-turquoise-bark.png",
      to_tiles = {
        "water",
        "deepwater",
        "water-green",
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/midland-turquoise-bark.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
