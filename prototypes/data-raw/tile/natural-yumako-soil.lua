return {
  autoplace = {
    probability_expression = "gleba_fertile_solid * 50000 - 40000 - gleba_biome_mask_green * 1000000"
  },
  build_sound = {
    large = {
  ...
  transitions = {
    ...
    },
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/natural-yumako-soil.png",
      to_tiles = {
        "water",
        "deepwater",
        "water-green",
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/natural-yumako-soil.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
