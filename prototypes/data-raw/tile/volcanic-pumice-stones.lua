return {
  ...
  variants = {
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/vulcanus/volcanic-pumice-stones.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
    ...
    transition = {
      ...
      spritesheet = "__space-age__/graphics/terrain/vulcanus/volcanic-pumice-stones.png"
    }
  },
