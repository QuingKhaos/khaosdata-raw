return {
  ...
  autoplace = {
    probability_expression = "gleba_lowland * gleba_select(gleba_aux, 0.7, 1, 0.005, 0, 1) * gleba_select(gleba_temperature_normalised, 0.25, 0.45, 0.005, 0, 1)"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  transitions = {
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/out-of-map-transition/gleba-out-of-map-transition-red.png",
      to_tiles = {
        "out-of-map",
        "empty-space"
      },
    ...
    },
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/lowland-red-vein-3.png",
      to_tiles = {
        "water",
        "deepwater",
        "water-green",
  ...
  transitions_between_transitions = {
    {
      ...
      offset_background_layer_by_tile_layer = true,
      overlay_enabled = false,
      spritesheet = "__space-age__/graphics/terrain/out-of-map-transition/gleba-out-of-map-transition-b-red.png",
      transition_group1 = 0,
      transition_group2 = 2
    },
    {
      ...
      offset_background_layer_by_tile_layer = true,
      overlay_enabled = false,
      spritesheet = "__space-age__/graphics/terrain/out-of-map-transition/gleba-shore-out-of-map-transition-red.png",
      transition_group1 = 1,
      transition_group2 = 2
    },
    {
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/lowland-red-vein-3.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
