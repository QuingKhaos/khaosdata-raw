return {
  ...
  variants = {
    light = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/vulcanus/volcanic-smooth-stone-warm-lightmap.png",
        scale = 0.5,
        size = 1,
        y = 0
      },
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/vulcanus/volcanic-smooth-stone-warm.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
    ...
    transition = {
      ...
      lightmap_layout = {
        spritesheet = "__space-age__/graphics/terrain/vulcanus/volcanic-smooth-stone-warm-lightmap.png"
      },
      spritesheet = "__space-age__/graphics/terrain/vulcanus/volcanic-smooth-stone-warm.png"
    }
  },
  ...
  walking_sound = {
    ...
    variations = {
      {
        filename = "__space-age__/sound/walking/warm-stone-1.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-2.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-3.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-4.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-5.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-6.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-7.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-8.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-9.ogg",
        volume = 1
      },
      {
        filename = "__space-age__/sound/walking/warm-stone-10.ogg",
        volume = 1
      }
    }
  },
