return {
  ...
  autoplace = {
    probability_expression = "gleba_lowland * gleba_select(gleba_aux, 0, 0.4, 0.005, 0, 1) + 0.1 * (gleba_plants_noise_b - 0.8)"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  transitions = {
    ...
    },
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/lowland-brown-blubber.png",
      to_tiles = {
        "water",
        "deepwater",
        "water-green",
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/lowland-brown-blubber.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
