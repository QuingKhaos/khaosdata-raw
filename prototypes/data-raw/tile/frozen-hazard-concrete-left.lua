return {
  ...
  name = "frozen-hazard-concrete-left",
  needs_correction = false,
  next_direction = "hazard-concrete-right",
  order = "z[frozen-concrete]-frozen-hazard-concrete-left",
  placeable_by = {
    count = 1,
  ...
  thawed_variant = "hazard-concrete-left",
  ...
  variants = {
    material_background = {
      count = 8,
      picture = "__space-age__/graphics/terrain/aquilo/frozen-hazard-concrete-left.png",
      scale = 0.5
    },
    transition = {
      mask_layout = {
