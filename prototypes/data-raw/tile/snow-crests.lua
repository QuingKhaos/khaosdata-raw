return {
  ...
  autoplace = {
    probability_expression = "snow_crests"
  },
  collision_mask = {
    layers = {
      ground_tile = true
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/aquilo/snow-crests.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
  ...
  walking_sound = {
    ...
    variations = {
      {
        filename = "__space-age__/sound/walking/snow-1.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-2.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-3.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-4.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-5.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-6.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-7.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-8.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-9.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
      ...
      {
        filename = "__space-age__/sound/walking/snow-10.ogg",
        modifiers = {
          type = "main-menu",
          volume_multiplier = 2.9
        },
