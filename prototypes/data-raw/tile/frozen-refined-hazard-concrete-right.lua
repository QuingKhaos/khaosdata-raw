return {
  ...
  name = "frozen-refined-hazard-concrete-right",
  needs_correction = false,
  next_direction = "refined-hazard-concrete-left",
  order = "z[frozen-concrete]-frozen-refined-hazard-concrete-right",
  placeable_by = {
    count = 1,
  ...
  thawed_variant = "refined-hazard-concrete-right",
  ...
  variants = {
    material_background = {
      count = 8,
      picture = "__space-age__/graphics/terrain/aquilo/frozen-refined-hazard-concrete-right.png",
      scale = 0.5
    },
    transition = {
      mask_layout = {
