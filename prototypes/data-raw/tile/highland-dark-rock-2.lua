return {
  ...
  autoplace = {
    probability_expression = "gleba_highland * max(0, 1.13 + 0.1 * (min(gleba_aux + 0.1, 1-gleba_aux)))"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  transitions = {
    ...
    },
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/highland-dark-rock-2.png",
      to_tiles = {
        "water",
        "deepwater",
        "water-green",
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/highland-dark-rock-2.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
