return {
  autoplace = {
    probability_expression = "gleba_fertile_solid * 50000 - 40000 - gleba_biome_mask_red * 1000000"
  },
  build_sound = {
    large = {
  ...
  transitions = {
    ...
    },
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/natural-jellynut-soil.png",
      to_tiles = {
        "water",
        "deepwater",
        "water-green",
