return {
  ...
  order = "z[frozen-concrete]-frozen-foundation",
  placeable_by = {
    count = 1,
    item = "foundation"
  },
  ...
  thawed_variant = "foundation",
  transition_merges_with_tile = "foundation",
  ...
  variants = {
    material_background = {
      count = 8,
      picture = "__space-age__/graphics/terrain/aquilo/frozen-foundation.png",
      scale = 0.5
    },
    transition = {
      mask_layout = {
