return {
  ...
  variants = {
    light = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/vulcanus/volcanic-cracks-warm-lightmap1.png",
        scale = 0.5,
        size = 1,
        y = 0
      },
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/vulcanus/volcanic-cracks-warm.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
    ...
    transition = {
      ...
      lightmap_layout = {
        spritesheet = "__space-age__/graphics/terrain/vulcanus/volcanic-cracks-warm-lightmap1.png"
      },
      spritesheet = "__space-age__/graphics/terrain/vulcanus/volcanic-cracks-warm.png"
    }
  },
