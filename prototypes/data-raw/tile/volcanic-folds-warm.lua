return {
  ...
  variants = {
    light = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/vulcanus/volcanic-folds-warm-lightmap.png",
        scale = 0.5,
        size = 1,
        y = 0
      },
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/vulcanus/volcanic-folds-warm.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
    ...
    transition = {
      ...
      lightmap_layout = {
        spritesheet = "__space-age__/graphics/terrain/vulcanus/volcanic-folds-warm-lightmap.png"
      },
      spritesheet = "__space-age__/graphics/terrain/vulcanus/volcanic-folds-warm.png"
    }
  },
