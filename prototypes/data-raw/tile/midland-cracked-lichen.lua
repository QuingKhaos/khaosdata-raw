return {
  ...
  autoplace = {
    probability_expression = "gleba_midland * gleba_select(gleba_aux, 0.55, 0.65, 0.15, 0, 1) - 0.2 * gleba_temperature_normalised"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  variants = {
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/cracked-lichen.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
    ...
    transition = {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/cracked-lichen.png"
    }
  },
