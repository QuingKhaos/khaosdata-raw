return {
  ...
  autoplace = {
    probability_expression = "gleba_highland * max(0, 1 + 0.1 * gleba_aux - 0.2 * gleba_temperature_normalised)"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  transitions = {
    ...
    },
    {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/highland-yellow-rock.png",
      to_tiles = {
        "water",
        "deepwater",
        "water-green",
    ...
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/highland-yellow-rock.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
