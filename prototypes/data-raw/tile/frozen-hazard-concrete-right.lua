return {
  ...
  name = "frozen-hazard-concrete-right",
  needs_correction = false,
  next_direction = "hazard-concrete-left",
  order = "z[frozen-concrete]-frozen-hazard-concrete-right",
  placeable_by = {
    count = 1,
  ...
  thawed_variant = "hazard-concrete-right",
  ...
  variants = {
    material_background = {
      count = 8,
      picture = "__space-age__/graphics/terrain/aquilo/frozen-hazard-concrete-right.png",
      scale = 0.5
    },
    transition = {
      mask_layout = {
