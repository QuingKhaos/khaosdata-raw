return {
  ...
  autoplace = {
    probability_expression = "gleba_midland * gleba_select(gleba_aux, 0.8, 1, 0.15, 0, 1) * (0.9 + 0.1 * gleba_select(gleba_moisture, 0.25, 0.25, 0.25, 0, 1) + 0.1 * gleba_temperature_normalised)"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  variants = {
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/starburst-lichen-4.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
    ...
    transition = {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/starburst-lichen-4.png"
    }
  },
  ...
  walking_sound = {
    ...
    variations = {
      {
        filename = "__space-age__/sound/walking/dry-rock-1.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-2.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-3.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-4.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-5.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-6.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-7.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-8.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-9.ogg",
        volume = 0.8
      },
      {
        filename = "__space-age__/sound/walking/dry-rock-10.ogg",
        volume = 0.8
      }
    }
  },
