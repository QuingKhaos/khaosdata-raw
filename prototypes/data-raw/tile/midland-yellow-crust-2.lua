return {
  ...
  autoplace = {
    probability_expression = "gleba_midland * gleba_select(gleba_aux, 0.8, 1, 0.15, 0, 1) * (0.93 + 0.1 * gleba_select(gleba_moisture, 0.5, 0.5, 0.25, 0, 1) - 0.1 * gleba_temperature_normalised)"
  },
  collision_mask = {
    layers = {
      ground_tile = true
  ...
  variants = {
    main = {
      {
        count = 16,
        line_length = 16,
        picture = "__space-age__/graphics/terrain/gleba/starburst-lichen-2.png",
        scale = 0.5,
        size = 1,
        weights = {
          0.085,
    ...
    transition = {
      ...
      spritesheet = "__space-age__/graphics/terrain/gleba/starburst-lichen-2.png"
    }
  },
